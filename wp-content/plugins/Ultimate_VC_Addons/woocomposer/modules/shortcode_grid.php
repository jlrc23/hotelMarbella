	...
	class WooComposer_GridView
	{
		...
		function woocomposer_init_grid(){
			if(function_exists('vc_map')){
				vc_map(
					array(
						"name"		=> __("Grid View [Beta]", "woocomposer"),
						...
						"params" => array(
							...
							array(
								...
								"value" => array("Enable pagination" => "enable"),
								"description" => __("", "woocomposer"),
								"group" => "Initial Settings",
							),
							array(
							...
							array(
								...
								"description" => __("", "woocomposer"),
								"dependency" => Array("element" => "display_elements", "value" => array("quick")),
								"group" => "Initial Settings",
							),
							array(
								"type" => "dropdown",
