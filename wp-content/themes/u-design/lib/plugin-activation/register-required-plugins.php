...
function udesign_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
                        'name'                  => 'Envato WordPress Toolkit', // The Envato Toolkit plugin
                        'slug'                  => 'envato-wordpress-toolkit', // The plugin slug (typically the folder name)
                        'source'                => get_template_directory() . '/lib/plugins/envato-wordpress-toolkit.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'notice_can_install_required'     			=> _n_noop( 'The "U-Design" theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.' ), // %1$s = plugin name(s)
			'notice_can_install_recommended'			=> _n_noop( 'The "U-Design" theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.' ), // %1$s = plugin name(s)
			...
			'notice_ask_to_update' 					=> _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s (<a href="'.get_bloginfo('template_url').'/scripts/documentation/index.html#plugins-update-instructions" title="Open the documentation" target="_blank">Plugins Update Instructions</a>).', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s (<a href="'.get_bloginfo('template_url').'/scripts/documentation/index.html#plugins-update-instructions" title="Open the documentation" target="_blank">Plugins Update Instructions</a>).' ), // %1$s = plugin name(s)
