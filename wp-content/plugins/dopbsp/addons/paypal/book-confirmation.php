...
//            $reasonCode = $resArray["PAYMENTINFO_0_REASONCODE"];   
            ...
            require_once('../../dopbsp-config.php');    
            require_once('../../dopbsp-email.php');  
            require_once('../../dopbsp-backend-reservations.php');  
            
            $language = isset($_SESSION['DOPBookingSystemPROFrontEndLanguage'.$DOPBSP_CalendarID_holder]) ? $_SESSION['DOPBookingSystemPROFrontEndLanguage'.$DOPBSP_CalendarID_holder]:DOPBSP_CONFIG_FRONTEND_DEFAULT_LANGUAGE;
