...
if ($cmd == "update") {
	...
	//}
	$current_options['display_where'] = in_array($options['display_where'], array('bottom', 'top', 'both', 'nowhere', 'float', 'sidebar', 'popup')) ? $options['display_where'] : 'bottom';
...
function essb_setting_radio_where() {
	...
	$w_bottom = $w_top = $w_both = $w_nowhere = $w_float = $w_sidebar = $w_popup = "";
	...
	echo '<td align="center" valign="top" style="background-color: #ffffff !important; border-top: 1px solid #dadada;"></td>';
		...
		<form name="general_form" method="post"
			...
			<table border="0" cellpadding="5" cellspacing="0" width="100%">
				...
				<tr class="even table-border-bottom">
					<td valign="top" class="bold"><?php _e('Where to display buttons:', ESSB_TEXT_DOMAIN); ?><br/><span class="label" style="font-weight: 400;">Choose post types where you wish buttons to appear. If you are running <span class="bold">WooCommerce</span> store you can choose between post type <span class="bold">Products</span> which will display share buttons into product description or option to display buttons below price.</span></td>
					<td class="essb_general_options"><?php essb_select_content_type(); ?></td>
				</tr>
				<tr class="odd table-border-bottom">
					<td valign="top" class="bold"><?php _e('Position of buttons:', ESSB_TEXT_DOMAIN); ?><br/><span class="label" style="font-weight: 400;">Choose default method that will be used to render buttons. You are able to provide custom options for each post/page.</span></td>
				...
				<tr class="even table-border-bottom">
					<td ></td>
					<td class="small">If your curent theme has fixed bar or menu you may need to provide custom top position of float or it will be rendered below this sticked bar. For example you can try with value 40 (which is equal to 40px from top).</td>
				</tr>
				<tr class="odd">
				...
				<tr class="odd table-border-bottom">
					<td></td>
					<td class="small">Default color provided for background of float bar is <span class="bold">#FFFFFF</span>. If you wish to change it you can enter other color in hex or rgba. For example your can set <span class="bold">#e1e1e1</span> or <span class="bold">rgba(200,200,200,1)</span></td>
				</tr>
				<tr>
					<td colspan="2" class="sub"><?php _e('Sidebar Settings', ESSB_TEXT_DOMAIN); ?></td>
				</tr>
				<tr class="even table-border-bottom">
					<td class="bold">Sidebar appearance:<br/><span class="label" style="font-weight: 400;">You choose different position for sidebar. Available options are Left (default), Right and Bottom</span></td>
				...
				<tr class="even table-border-bottom">
					<td class="bold">Automatically close popup after (sec):<br/><span class="label" style="font-weight: 400;">You can provide seconds and after they expire window will close automatically. User can close this window manually by pressing close button.</span></td>
					<td class="essb_general_options"><?php essb_popup_window_close_after(); ?>
				</tr>
				<tr class="odd table-border-bottom">
					<td class="bold">Display popup window after (sec):<br/><span class="label" style="font-weight: 400;">If you wish popup window to appear after amount of seconds you can provide theme here. Leave blank for immediate popup after page load.</span></td>
				...
				<tr class="odd table-border-bottom">
					<td></td>
					<td class="small">This option will disable network name pop out when you activate Hide Social Network Names. This option is activated by default on mobile devices and can't be turned off.</td>
				</tr>
				<tr class="even table-border-bottom">
				...
				<tr class="even table-border-bottom">
					<td class="bold" valign="top">Hide total counter when display counter of sharing is active:</td>
				...
				<tr class="odd table-border-bottom">
					<td class="bold" valign="top">Custom message on social network hover:</td>
