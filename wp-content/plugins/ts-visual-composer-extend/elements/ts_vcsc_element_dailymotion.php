<?php
    if (function_exists('vc_map')) {
        vc_map( array(
            "name"                          => __( "TS Motion Video", "js_composer" ),
            "base"                          => "TS-VCSC-Motion",
            "icon" 	                        => "icon-wpb-ts_vcsc_motion",
            "class"                         => "",
            "category"                      => __( 'VC Extensions', 'js_composer' ),
            "description"                   => __("Place a DailyMotion Video", "js_composer"),
            "admin_enqueue_js"              => "",
            "admin_enqueue_css"             => "",
            "params"                        => array(
                // DailyMotion Video
                ...
                array(
                    "type"                  => "textfield",
                    "heading"               => __( "DailyMotion Video URL", "js_composer" ),
                    "param_name"            => "content_motion",
                    "value"                 => "",
                    "admin_label"           => true,
                    "description"           => __( "Enter the URL for the DailyMotion video.", "js_composer" ),
                    "dependency"            => ""
                ),
				array(
					"type"              	=> "switch",
				...
				array(
                    ...
                    "value"                 => array(
                        __("DailyMotion Cover", "js_composer")      => "preview",
                ...
                array(
                    ...
                    "admin_label"           => true,
                    "description"           => __( "Select the transition effect to be used for the video in the lightbox.", "js_composer" ),
                    "dependency"            => array( 'element' => "content_lightbox", 'value' => "true" )
                ),
                // Tooltip Settings
				array(
