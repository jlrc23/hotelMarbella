...
//                    $dataIDS = explode('<br /><strong>'.DOPBSP_EMAIL_CALENDAR_NAME.':</strong> ',str_replace('<strong>'.DOPBSP_EMAIL_RESERVATION_ID.':</strong> ',"",$ids));
//                    $reservationID = $dataIDS[0];
//                    $reservation = $wpdb->get_row('SELECT * FROM '.DOPBSP_Settings_table.' WHERE calendar_id="'.$_POST['calendar_id'].'"');
