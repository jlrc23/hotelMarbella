...
function udesign_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   		=> 'udesign-shortcode-insert-button.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   		=> 'u-design-woocommerce.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 		=> '2.1.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 	=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 		=> '', // If set, overrides default API URL and points to an external URL
		),
		...
		array(
			...
			'source'   		=> 'flickr-rss.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
                        ...
                        'source'                => 'envato-wordpress-toolkit.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
	 ...
	 */
	$config = array(
            'default_path' => get_template_directory() . '/lib/plugins/', // Default absolute path to pre-packaged plugins.
