				...
				vc_map(
					array(
					   ...
					   "params" => array(
							...
							array(
								"type" => "text",
								"heading" => __("<h2>Heading Settings</h2>"),
							...
							array(
								"type" => "text",
								"heading" => __("<h2>Sub Heading Settings</h2>"),
