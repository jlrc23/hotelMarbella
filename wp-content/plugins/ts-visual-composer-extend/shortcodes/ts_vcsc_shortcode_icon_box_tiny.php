<?php
	...
	function TS_VCSC_Font_Iconbox_Tiny_Function ($atts, $content = null) {
		...
		$output .= '<div id="' . $icon_box_id . '" style="margin-bottom:' . $margin_bottom . 'px; margin-top:' . $margin_top . 'px;" class="ts-vcsc-box-icon ' . $el_class . $animation_css . ' ' . $style . '-style ts-box-icon">';
		$output .= (!empty($animation_box) ? '<div class="ts-hover ' . $animation_box . '">' : '');
			if ($style == "icon_left") {
				$output .= '<div class="ts-css-shadow ' . $animation_shadow . '" style="' . $box_background_style . '">';
					$output .= '<div class="box-detail-wrapper ' . $box_border_radius . '" style="' . $box_frame_style . '">';
						...
						if (function_exists('wpb_js_remove_wpautop')){
							$output .= '<div class="ts-icon-box-content" style="">' . wpb_js_remove_wpautop(do_shortcode($content), true) . '</div>';
						} else {
							$output .= '<div class="ts-icon-box-content" style="">' . do_shortcode($content) . '</div>';
						}
				...
				$output .= '<div class="ts-css-shadow ' . $animation_shadow . '" style="background-color: ' . $box_background_color .'; ' . $shadow_frame_adjust . '">';
