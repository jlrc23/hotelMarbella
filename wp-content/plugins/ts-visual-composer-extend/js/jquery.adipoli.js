...
(function($) {
    $.fn.adipoli = function(options) {
        ...
        $(this).one('load', function() {
            ...
            var $adipoli_width = $(this).width();
            var $adipoli_height = $(this).height();
            ...
            $(this).parent().bind('mouseenter',function(){
                if(settings.hoverEffect=='normal') {
                    var element=$(this);
                    element.children('.adipoli-after').html('<img src="'+element.children('img').attr('src')+'" style="width:'+$adipoli_width+'px; height:'+$adipoli_height+'px;"/>').fadeIn(settings.animSpeed);
                    ...
                    element.children('.adipoli-after').html('<img src="'+element.children('img').attr('src')+'" style="width:'+$adipoli_width+'px; height:'+$adipoli_height+'px;"/>');
