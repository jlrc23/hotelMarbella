        ...
        vc_map( array(
            ...
            "params"                        => array(
				...
				array(
					...
					"value"                 => "",
                    "admin_label"           => true,
					"description"           => __( "Select the images for your gallery overlay; move images to arrange order in which to display.", "js_composer" ),
                ...
                array(
                    ...
                    "value"                 => "",
                    "description"           => __( "Enter titles for images; seperate by line break; use an empty line for image without title.", "js_composer" ),
                    "dependency"            => ""
                ),
				// Gallery Info
				array(
                ...
                array(
                    ...
                    "width"                 => 150,
                    "value"                 => array(
                        __( 'Auto Grid of all Images', "js_composer" )		=> "grid",
                        __( 'First Image Only', "js_composer" )				=> "first",
						__( 'Single Custom Image', "js_composer" )			=> "image",
                    ),
                    "description"           => __( "Select how the lightbox should be previewed on your page.", "js_composer" ),
                    "dependency"            => ""
                ),
				array(
					"type"                  => "attach_image",
					...
					"value"                 => "",
					"description"           => __( "Select the trigger image for lightbox gallery.", "js_composer" ),
                ...
                array(
                    ...
                    "value"                 => "",
                    "admin_label"           => true,
                    "description"           => __( "Enter a title for the image that triggers the lightbox.", "js_composer" ),
                    "dependency"            => array( 'element' => "content_style", 'value' => 'image' )
                ),
				array(
					"type"                  => "textfield",
