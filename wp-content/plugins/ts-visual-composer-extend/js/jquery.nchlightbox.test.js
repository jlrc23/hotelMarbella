...
( function( $, ndef ){
	...
	types = {
		youtube : {
			...
			create : function( e ){
				return '<iframe class="nch-lb-iframe nch-video-youtube" src="http://www.youtube.com/embed/' + e.opts.videoid + '?wmode=opaque" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowfullscreen></iframe>';
			},
			thumb : function( e, fn ){
		...
		vimeo : {
			...
			create : function( e ){
				return '<iframe class="nch-lb-iframe nch-video-vimeo" src="http://player.vimeo.com/video/' + e.opts.videoid + '" width="500" height="500" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';			
			},
			thumb : function( e, fn ){
		...
		dailymotion : {
			...
			create : function( e ){
				return '<iframe class="nch-lb-iframe nch-video-dailymotion" src="http://www.dailymotion.com/embed/video/' + e.opts.videoid + '" width="500" height="500" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';			
			},
			thumb : function( e, fn ){
	...
	utils = {
		...
		mediaItem : function( e, p ){
			...
			// Start Custom Addition
			e.attr("data-hash", utils.getHash( p ));
			// End Custom Addition
