	...
	function insertudesignSILink() {
		...
		// which tab is active ?
                if (ibMiscellaneous.className.indexOf('current') != -1) {
                        ...
                        else if(selectedMiscellaneousShortcode == 'content_block') {
                            shortcodetext = '[content_block bg_image="<?php echo get_bloginfo('template_url'); ?>/styles/common-images/parallax-bg.jpg" max_bg_width="yes" bg_fixed="yes" bg_position="center top" bg_repeat="repeat-x" parallax_scroll="no" bg_color="#969696" content_padding="40px 0" font_color="#FFFFFF" class="class-name"]Your content goes here...[/content_block]';
                        }
                        // Content Toggle
			...
			var ibButtonTarget = document.getElementById('ib-button-target-blank').checked;
                        ...
                        if(selectedButton == '1') {
                            shortcodetext = '[small_button text="Cool Button..." title="Cool Button" url="#" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+' style="light"]';
                        } else if(selectedButton == '2') {
                            shortcodetext = '[small_button text="Cool Button..." title="Cool Button" url="#" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+']';
                        } else if(selectedButton == '3') {
                            shortcodetext = '[button text="Cool Button..." title="Cool Button..." url="#" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+' style="light"]';
                        } else if(selectedButton == '4') {
                            shortcodetext = '[button text="Cool Button..." title="Cool Button..." url="#" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+']';
                        } else if(selectedButton == '5') {
                            shortcodetext = '[round_button text="Cool Button..." title="Cool Button" url="#" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+' style="light"]';
                        } else if(selectedButton == '6') {
                            shortcodetext = '[round_button text="Cool Button..." title="Cool Button" url="#" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+']';
                        } else if(selectedButton == '7') {
                            shortcodetext = '[custom_button text="Custom Button" title="Custom Button" url="#" size="'+ibButtonSize+'" bg_color="#FF5C00" text_color="#FFFFFF" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+']';
...
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');" style="display: none">
    ...
    <div style="margin: 5px auto 12px;"><h4>To preview examples of the shortcodes click <a href="http://www.universallyacclaimed.com/wp-themes/u-design/?page_id=59" target="_blank">HERE</a></h4></div>
	...
	<div class="panel_wrapper"  style="height:180px;">
		...
		<div id="ib-miscellaneous-panel" class="panel current">
                    ...
                    <select name="ib-miscellaneous-shortcode" id="ib-miscellaneous-shortcode">
                            ...
                            <option value="content_block">Content Block (with Parallax option)</option>
