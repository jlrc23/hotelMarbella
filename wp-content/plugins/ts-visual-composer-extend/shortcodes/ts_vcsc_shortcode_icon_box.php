<?php
	...
	function TS_VCSC_Font_Iconbox_Function ($atts, $content = null) {
		...
		$output .= '<div id="' . $icon_box_id . '" style="margin-bottom:' . $margin_bottom . 'px; margin-top:' . $margin_top . 'px;" class="ts-vcsc-box-icon ' . $box_border_radius . ' ' . $el_class . $animation_css . ' ' . $style . '-style ts-box-icon">';
