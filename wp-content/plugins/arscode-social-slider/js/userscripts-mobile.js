jQuery(document).ready(function(){	
	...
	jQuery('.fblbRight.fblbCenterOuterPi').find('.fblbHead').toggle(
		function(){
			jQuery(this).parents('.fblbCenterOuter').css('z-index',9999999);
	...
	jQuery('.fblbLeft.fblbCenterOuterPi').find('.fblbHead').toggle(
		function(){
			jQuery(this).parents('.fblbCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.fblbCenterOuterPi').stop(true,false).animate({
				left: -3
	...
	jQuery('.fblbRight.fblbCenterOuterInst').find('.fblbHead').toggle(
		function(){
			jQuery(this).parents('.fblbCenterOuter').css('z-index',9999999);
	...
	jQuery('.fblbLeft.fblbCenterOuterInst').find('.fblbHead').toggle(
		function(){
			jQuery(this).parents('.fblbCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.fblbCenterOuterInst').stop(true,false).animate({
				left: -3
