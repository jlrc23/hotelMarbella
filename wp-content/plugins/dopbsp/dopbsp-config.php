...
// ***************************************************************************** Begin Custom Post Type Defaults
    ...
    define('DOPBSP_CONFIG_CUSTOM_POST_OVERWRITE_POSTS_LOOP', false); // Set to "true" if you want to add Booking System Custom Posts in blog posts.
    define('DOPBSP_CONFIG_CUSTOM_POST_NOT_ALLOWED_POST_TYPES_IN_LOOP', 'page,attachment,nav_menu_item,revision'); // The slugs of the post types, separated by comma, that will not appear in blog posts.
...
// Extras groups    
    define('DOPBSP_CONFIG_DATABASE_EXTRAS_GROUPS_DEFAULT_EXTRAS_ID', 0);
    define('DOPBSP_CONFIG_DATABASE_EXTRAS_GROUPS_DEFAULT_POSITION', 0);
    define('DOPBSP_CONFIG_DATABASE_EXTRAS_GROUPS_DEFAULT_TYPE', 'select');
...
// Extras groups items     
    define('DOPBSP_CONFIG_DATABASE_EXTRAS_GROUPS_ITEMS_DEFAULT_EXTRAS_GROUPS_ID', 0);
    ...
    define('DOPBSP_CONFIG_DATABASE_EXTRAS_GROUPS_ITEMS_DEFAULT_PRICE_BY', 'one_time');
