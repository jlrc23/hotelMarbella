...
if($options['TabPosition']=='Middle' && in_array($options['TabDesign'],array(11,13)))
{
	$fblbHead_position='top: 50%; margin-top: -54px;';
}
if($options['TabPosition']=='Middle' && in_array($options['TabDesign'],array(12,14)))
{
	$fblbHead_position='top: 50%; margin-top: -39px;';
}
