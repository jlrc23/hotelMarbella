	...
	class WooComposer_ViewList
	{
		...
		function woocomposer_init_grid(){
			if(function_exists('vc_map')){
				vc_map(
					array(
						"name"		=> __("List View [Beta]", "woocommerce"),
						...
						"params" => array(
							array(
								"type" => "woocomposer",
								"class" => "",
								"heading" => __("Query Builder", "woocommerce"),
							...
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Image Display", "woocommerce"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Image Width", "woocommerce"),
								"param_name" => "img_size",
								"value" => "",
								"min" => 30,
								"max" => 300,
							...
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Image Border", "woocommerce"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Border Size", "woocommerce"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Border Radius", "woocommerce"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Border Color", "woocommerce"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Product Title Font Size", "woocommerce"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Product Title Color", "woocommerce"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Product Price Font Size", "woocommerce"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Product Price Color", "woocommerce"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Star Rating Font Size", "woocommerce"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Star Ratings Color", "woocommerce"),
		...
		function woocomposer_list_shortcode($atts){
			...
			$output .= '<ul class="wcmp-product-list wcmp-img-'.$img_position.'">';
			if($query->have_posts()):
